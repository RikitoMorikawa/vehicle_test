// src/components/admin/loan-review-detail/page.tsx
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white shadow rounded-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  {/* 居住情報（新規追加） */}
                  <div>
                    <label className="text-sm font-medium text-gray-500">居住形態</label>
                    <p className="text-gray-900">{application.residence_type || "未入力"}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">居住年数</label>
                    <p className="text-gray-900">{application.residence_years || 0}年</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">配偶者の有無</label>
                    <p className="text-gray-900">{application.marital_status || "未入力"}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">扶養人数</label>
                    <p className="text-gray-900">{application.dependents_count || 0}人</p>
                  </div>
                  {application.family_composition && (
                    <div>
                      <label className="text-sm font-medium text-gray-500">家族構成</label>
                      <p className="text-gray-900">{application.family_composition}</p>
                    </div>
                  )}
                </div>
              </div>
