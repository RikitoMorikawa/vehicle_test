    ...
    <div className="border-b border-gray-200 pb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Input
          ...
          error={errors?.["loanCalculation.down_payment"]}
        />
        <Input
          label="元金"
          type="number"
          ...
          error={errors?.["loanCalculation.principal"]}
        />
        <Input
          label="金利手数料"
          type="number"
          ...
          error={errors?.["loanCalculation.interest_fee"]}
        />
        <Input
          label="支払総額"
          type="number"
          ...
          error={errors?.["loanCalculation.total_payment"]}
        />
        <Input
          label="支払回数"
          type="number"
          ...
          error={errors?.["loanCalculation.payment_count"]}
        />
        <Input
          label="支払期間"
          type="number"
          ...
          error={errors?.["loanCalculation.payment_period"]}
        />
        <Input
          label="初回支払額"
          type="number"
          ...
          error={errors?.["loanCalculation.first_payment"]}
        />
        <Input
          label="月々支払額"
          type="number"
          ...
          error={errors?.["loanCalculation.monthly_payment"]}
        />
        <Input
          label="ボーナス加算額"
          type="number"
          ...
          error={errors?.["loanCalculation.bonus_amount"]}
        />
      </div>
    </div>
  );
