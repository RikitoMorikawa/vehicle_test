...
<body>
    ...
    ${
      documentType === "order"
        ? `
      <!-- 2ページ目：特約条項 -->
      <div class="page-break contract-terms">
          <h2>特 約 条 項</h2>
          
          <ol>
              <li><strong>(申込金の性格と充当)</strong><br>
              1注文者は販売会社に対し注文と同時に申込金を支払うものとします。<br>
              2申込金は手付金ではありません。<br>
              3申込金は契約成立後に、売買代金の一部に充当されるものとします。</li>
              
              <li><strong>(注文に応じられない場合)</strong><br>
              この注文書における販売会社(以下、販売会社)がこの注文に応じられない場合、この契約を解除されてもこの注文書における注文者(以下、注文者)は一切異議のないものとします。この場合、申込金はそのまま注文者に返還されるものとします。</li>
              
              <li><strong>(申込みの撤回又は契約の解除による損害賠償)</strong><br>
              注文者の都合により申込みを撤回した場合又は契約の解除をした場合、注文者は販売会社に対し当該車輛本体価格の2割相当額を損害賠償金として請求されても異議のないものとします。この場合申込金と対等額で相殺されても異議のないものとします。又申込み後販売会社の指定のない場合において、一ヶ月以内に全額支払えない場合には、販売会社において申込みの撤回の手続きをとられても異議のないものとします。</li>
              
              <li><strong>(契約の成立時期)</strong><br>
              この注文書による契約の成立は、申込金を支払った日又は注文書交付日のいずれか早い方とします。</li>
              
              <li><strong>(支払について)</strong><br>
              注文者は頭金を契約成立日に、残金を販売会社の定めた支払期日に従い納車日までにその全額を販売会社に支払うものとします。</li>
              
              <li><strong>(所有権移転の時期について)</strong><br>
              当該車輛の所有権移転手続きの時期は売買代金完済時とします。</li>
              
              <li><strong>(下取車の性格・担保責任・再査定)</strong><br>
              注文者は下取自動車を売買代金の一部の支払いの為、代物弁済として販売会社に引渡します。従って下取自動車について差押、公租公課の滞納等一切の負担のないこと及び走行距離改竄等のないことを保証し、万一負担もしくはメーター改竄等がある場合は注文者の責任において処理することとします。又当該下取自動車が、販売会社に引渡すまでの間に、状態に変化が生じた場合は、再査定された価格をもって下取価格とされても異議のないものとします。</li>
              
              <li><strong>(下取自動車の賠償責任保険料及び自動車税)</strong><br>
              当該下取自動車の未経過保険料及び自動車税期日未経過分は、その相当額を下取価格に含めるものとします。</li>
              
              <li><strong>(下取自動車の引渡し時期と引取り費用)</strong><br>
              注文者は当該下取自動車を、注文した自動車の引渡しと引替えに販売会社に引渡すものとします。また下取自動車が自走不能の場合は、下取諸費用の他にその引取り費用を販売会社に支払う事とします。</li>
              
              <li><strong>(中古車の瑕疵担保責任)</strong><br>
              中古車の注文者は、価格ステッカー及び車輛状態説明書、もしくは整備明細書に表示の走行距離、前使用者の使用状況により生じる瑕疵について、一切異議のないものとします。保証書の交付を受けた場合はその範囲内の保証がなされるものとします。</li>
              
              <li><strong>(納入の遅延)</strong><br>
              メーカーのストライキあるいは港湾のストライキ、注文者の依頼に基づく修理・改造・架装等による遅れ、その他販売会社の責に帰し得ない事由により当該注文自動車の納入が遅れた場合、注文者はこれを認める事とします。</li>
              
              <li><strong>(安全基準等による改造)</strong><br>
              道路運送車輛法に基づく安全基準に適合する改善指導等により行われた改造の為、カタログ現車と一部異なる場合、注文者はこれを認めるものとします。</li>
              
              <li><strong>(管轄合意)</strong><br>
              本契約により生ずる権利義務に関する訴訟について注文者は、販売会社所在の裁判所を第一審の裁判所とする事に同意するものとします。</li>
          </ol>
          
          <div class="signature-area">
              <p>上記特約条項を読み確認、納得致しました。</p><br>
              <p>署名<span style="display:inline-block; width: 20em;"></span></p>
          </div>
      </div>
      `
        : ""
