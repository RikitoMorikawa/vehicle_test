...
// const AccessoriesInfo: React.FC<AccessoriesInfoProps> = ({ accessories, onInputChange }) => {
...
//           <Input label="品名" value={newAccessory.name} onChange={(e) => setNewAccessory({ ...newAccessory, name: e.target.value })} />
//           <Input
//             label="価格"
//             type="number"
