...
import type { EstimateError, EstimateFormData, ShippingInfo } from "../../validations/document-edit/page";
...
import { accessorySchema } from "../../validations/document-edit/page";
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <div className="mb-6">
          <p className="text-sm text-gray-600 mb-2">以下の内容で{documentTypeText}を更新します：</p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white shadow rounded-lg">
              ...
              <div className="ml-4 border-b border-gray-200 pb-6 pt-4">
                <h1 className="text-2xl font-bold text-gray-900 mb-2">書類編集</h1>
                <p className="text-gray-600">書類ID: {documentId}</p>
              </div>
